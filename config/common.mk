...
ifndef SLIM_BUILD_TYPE
    SLIM_BUILD_TYPE := AutoDroid
    PLATFORM_VERSION_CODENAME := AutoDroid
...
# Set all versions
SLIM_VERSION := AutoDroid-$(PRODUCT_VERSION_MAJOR).$(PRODUCT_VERSION_MINOR).$(PRODUCT_VERSION_MAINTENANCE)
SLIM_MOD_VERSION := AutoDroid-$(SLIM_BUILD)-$(PRODUCT_VERSION_MAJOR).$(PRODUCT_VERSION_MINOR).$(PRODUCT_VERSION_MAINTENANCE)
